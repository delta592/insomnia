...
export const PaneHeader: FC<PropsWithChildren<PaneHeaderProps>> = ({ className, children }) => (
  <header className={classnames('pane__header', 'theme--pane__header', className)}>{children}</header>
);
...
export const PaneBody: FC<PropsWithChildren<PaneBodyProps>> = ({ placeholder, children }) => (
  <div className={classnames(paneBodyClasses, placeholder && 'pane__body--placeholder')}>{children}</div>
);
